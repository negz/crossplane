...
var file_daytwo_fn_proto_v1alpha1_run_function_proto_goTypes = []any{
...
func file_daytwo_fn_proto_v1alpha1_run_function_proto_init() {
	...
	file_daytwo_fn_proto_v1alpha1_run_function_proto_msgTypes[0].OneofWrappers = []any{}
	file_daytwo_fn_proto_v1alpha1_run_function_proto_msgTypes[2].OneofWrappers = []any{}
	file_daytwo_fn_proto_v1alpha1_run_function_proto_msgTypes[5].OneofWrappers = []any{
		(*ResourceSelector_MatchName)(nil),
		(*ResourceSelector_MatchLabels)(nil),
	}
	file_daytwo_fn_proto_v1alpha1_run_function_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
