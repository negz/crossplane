...
func ReadRuntimeConfig(path string) (*runtime.Spec, error) {
...
// WriteRuntimeConfig writes the supplied OCI runtime spec to a file at the
// supplied path.
