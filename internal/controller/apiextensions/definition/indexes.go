...
// AddIndexes adds composite resource related indexes to the supplied
// FieldIndexer.
func AddIndexes(ctx context.Context, fi client.FieldIndexer) error {
	u := &kunstructured.Unstructured{}
	return errors.Wrap(fi.IndexField(ctx, u, compositeResourcesRefsIndex, IndexCompositeResourcesRefs), "cannot add cache index for composed resources")
}
