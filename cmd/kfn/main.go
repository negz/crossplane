...
// Package main is the Kubernetes implementation of Composition Functions.
package main
...
import (
	...
	"github.com/crossplane/crossplane/cmd/kfn/run"
	"github.com/crossplane/crossplane/cmd/kfn/start"
